...
<text>
    <slices>
        <title> </title>
        <slice size="17" color="#FF9200">Очистка приложений, рекомендуется предварительно проверить конфигурационные файлы</slice>
    </slices>
</text>
'
...
if [ -z "$(ls "$work_dir/$app_config_dir/")" ]; then
    ...
    <text>
        <slices>
            <title> </title>
            <slice size="30" color="#FF3E00">Нет конфигураций очистки приложений!</slice>
        </slices>
    </text>
    '
    exit 0
