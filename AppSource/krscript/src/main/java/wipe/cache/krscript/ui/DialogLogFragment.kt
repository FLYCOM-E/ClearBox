...
import wipe.cache.krscript.executor.ShellExecutor
        ...
        if (nodeInfo != null) {
            nodeInfo?.run {
                ...
                if (shellHandler != null) {
                    ShellExecutor().execute(activity ?: return, this, script, onExit, params as HashMap<String?, String?>?, shellHandler)
                }
            }
        } else {
            dismiss()
