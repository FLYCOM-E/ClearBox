...
[![THChat](https://img.shields.io/badge/YHchat-8068E2.svg?logo=icloud&logoColor=white)](https://yhfx.jwznb.com/share?key=yigOTedUjh62&ts=1747355950)
   ...
   # 🌍 ？
> **|** [**English**](https://github.com/FLYCOM-E/ClearBox/blob/main/README.md) **|** [**简体中文**](https://github.com/FLYCOM-E/ClearBox/blob/main/README_zh-CN.md) **|** **正體中文** **|**
...
export TARGET_ABI=aarch64 #(可選 aarch64、armv7a、x86_64、riscv64、i686)
...
配置方式：在配置檔案目錄新建 **conf** 文件文件，該檔案名稱會顯示在清理頁面當作對應清理項名稱，將自訂檔案附檔名填入該檔案，使用空格或換行分隔，不支援註解。

在檔案內填寫 **`@MAX=<size/B/K/M/G>`**、**`MIN=<size/B/K/M/G>`** 可以指定目標檔案大小區間，覆蓋解析，後面的會覆蓋前面的設定，因此您可以利用此特性寫出您想要的規則
...
此宣告指明僅歸類最大 **1 G**，最小 **10 MB** 的 **zip**、**7z**，但 **iso**、**img** 則不限制最大大小
