...
static const LangPack lang_packs[] =
{
    [LANG_zh_CN] =
    {
        ...
        .l_ac_clear_path_success = " » %s 处理成功！%f %c\n",
        .l_ac_clean_successful = " » 软件规则处理成功！共清理：%f %c\n",
        ...
        .l_sr_clear_successful = " » 清理 %s 成功！%f %c\n",
    ...
    [LANG_zh_TW] =
    {
        ...
        .l_ac_clear_path_success = " » %s 處理成功！%f %c\n",
        .l_ac_clean_successful = " » 軟體規則處理成功！共清理：%f %c\n",
    ...
    [LANG_en_US] =
    {
        ...
        .l_ac_clear_path_success = " » %s processed successfully! %f %c\n",
        .l_ac_clean_successful = " » Software rules applied successfully! Total cleaned: %f %c\n",
        ...
        .l_sr_clear_successful = " » Cleaned %s successfully! %f %c\n",
