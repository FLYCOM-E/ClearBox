...
#define L_MKDIR_ERROR " » %s 目录创建失败: %s\n"
#define L_GET_APPLIST_ERROR " » 获取软件列表失败！\n"
#define L_GET_SYS_VERSION_ERR " » 获取系统版本失败！\n"
...
#define L_PATH_FILE_ERROR " » PATH 配置错误，自动重写 ... 请您重新尝试，如失败请删除 %s 后更新配置再试\n"

#define L_CLEAR_ALL "一键优化清理\n"
#define L_CLEAR_CACHE "清理软件缓存\n"
#define L_CLEAR_SYS_CACHE "清理系统缓存\n"
#define L_CUST_STORAGE_CLEAN "自定义规则储存清理\n"
#define L_STORAGE_CLEAN "储存目录清理\n"
#define L_FILE_CLEAN "文件清理\n"
#define L_CUST_APP_CLEAN "自定义软件规则清理\n"
#define L_APP_CLEAN "软件规则清理\n"
#define L_FILE_ALL "文件归类\n"
#define L_STOP_INSTALL "阻止安装\n"
#define L_LOCK_STORAGE "储存锁定\n"
#define L_FAST_DISK_GC "快速磁盘优化\n"
#define L_DISK_GC "磁盘 GC\n"
#define L_SYS_DEXOAT "系统 DEXOAT\n"
#define L_CUST_DEXOAT "自定义 DEXOAT\n"
#define L_RESET_DEXOAT "恢复 DEXOAT\n"
#define L_CONFIG_MG "配置备份/恢复\n"
#define L_STOP_CACHE_DAEMON "阻止缓存 (Daemon)\n"
#define L_TIME_DAEMON "自动任务 (Daemon)\n"
...
#define L_TD_CONFIG_WRITE_ERROR " » %s 配置回写失败.\n"
...
#define L_AC_CLEAN_FAILED " » 未找到指定软件配置或发生错误！#%d\n"
