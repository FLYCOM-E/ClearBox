...
#define L_CONFIG_PATH_NOTFOUND " » 配置路徑不存在/不可存取！\n"
#define L_CONFIG_NOTFOUND " » %s 配置檔案不存在！\n"
#define L_CONFIG_PATH_TOOLONG " » 配置路徑過長！\n"
#define L_BIN_PATH_NOTFOUND " » Bin 路徑不存在/不可存取！\n"
...
#define L_PATH_STAT_FAILED " » 獲取 %s 資訊失敗！\n"
#define L_W_SETPROP_ERR " » 警告：PROP設定失敗！\n"
#define L_MOVE_ERROR " » %s 移動失敗\n"
#define L_DELETE_ERR " » 刪除 %s 失敗！\n"
#define L_SERVER_START_ERR " » 進程啟動失敗！\n"

// For StopCached
#define L_SCD_START_SUCCESS " » 快取阻止已啟動！\n"
...
#define L_TD_CONFIG_WRITE_ERROR " » %s 配置回寫失敗，原因：%s\n"

// For AppClean.c
#define L_AC_CLEAR " » 清理 %s &\n"
#define L_AC_CONFIG_NOTFOUND " » 無App清理配置！\n"
