// 通用宏
#define L_NOT_USE_ROOT " » 請使用 Root 權限！#%u\n"
...
#define L_GET_SYS_VERSION_ERR " » 獲取系統版本失敗！\n"
...
#define L_CLEAR_ALL "一鍵優化清理\n"
#define L_CLEAR_CACHE "清理軟體快取\n"
#define L_CLEAR_SYS_CACHE "清理系統快取\n"
#define L_CUST_STORAGE_CLEAN "自訂規則儲存清理\n"
#define L_STORAGE_CLEAN "儲存目錄清理\n"
#define L_FILE_CLEAN "檔案清理\n"
#define L_CUST_APP_CLEAN "自訂軟體規則清理\n"
#define L_APP_CLEAN "軟體規則清理\n"
#define L_FILE_ALL "檔案歸類\n"
#define L_STOP_INSTALL "阻止安裝\n"
#define L_LOCK_STORAGE "儲存鎖定\n"
#define L_FAST_DISK_GC "快速磁碟最佳化\n"
#define L_DISK_GC "磁碟 GC\n"
#define L_SYS_DEXOAT "系統 DEXOAT\n"
#define L_CUST_DEXOAT "自訂 DEXOAT\n"
#define L_RESET_DEXOAT "恢復 DEXOAT\n"
#define L_CONFIG_MG "配置備份/恢復\n"
#define L_STOP_CACHE_DAEMON "阻止快取 (Daemon)\n"
#define L_TIME_DAEMON "自動任務 (Daemon)\n"

// For StopCached
#define L_SCD_START_SUCCESS " » 快取阻止已啟動！#%u"
#define L_SCD_GETAPP_ERR_EXIT " » 進程已退出，原因：GETTOPAPP ERROR\n"
...
#define L_FM_MIN_SIZE_ERROR " » 警告：%s 配置 MIN 大小大於 MAX，MIN 已自動失效！\n"
#define L_FM_SIZE_MAX_ERROR " » 警告：%s 配置 MAX 宣告填寫錯誤！已忽略\n"
#define L_FM_SIZE_MIN_ERROR " » 警告：%s 配置 MIN 宣告填寫錯誤！已忽略\n"
#define L_FM_SIZE_ERROR " » 警告：%s 配置大小範圍單位填寫錯誤！已忽略對應值\n"
...
#define L_SC_SUCCESSFUL_SD " » 外部儲存裝置 %s 清理完成！\n » 共清理 %d 個空檔案/資料夾及 Log 檔案\n"
#define L_SC_CLEAR " » 正在清理 %s 儲存快取\n"
#define L_SC_CLEAR_ERR " » 清理 %s 儲存快取失敗！\n"
#define L_SC_CLEAR_CACHE_DONE " » 共清理 %d 個應用程式快取！\n"
#define L_SC_CLEAR_DIRTY_ERR " » 空檔案/資料夾及 Log 檔案清理失敗！\n"
