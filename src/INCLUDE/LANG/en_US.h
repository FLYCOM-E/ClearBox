...
#define L_GET_SYS_VERSION_ERR " » Failed to get system version!\n"
...
#define L_CLEAR_ALL "One-click optimize & cleanup\n"
#define L_CLEAR_CACHE "Clear app cache\n"
#define L_CLEAR_SYS_CACHE "Clear system cache\n"
#define L_CUST_STORAGE_CLEAN "Custom storage rule cleanup\n"
#define L_STORAGE_CLEAN "Storage directory cleanup\n"
#define L_FILE_CLEAN "File cleanup\n"
#define L_CUST_APP_CLEAN "Custom app rule cleanup\n"
#define L_APP_CLEAN "App rule cleanup\n"
#define L_FILE_ALL "File organization\n"
#define L_STOP_INSTALL "Block installation\n"
#define L_LOCK_STORAGE "Storage lock\n"
#define L_FAST_DISK_GC "Fast disk optimization\n"
#define L_DISK_GC "Disk GC\n"
#define L_SYS_DEXOAT "System DEXOAT\n"
#define L_CUST_DEXOAT "Custom DEXOAT\n"
#define L_RESET_DEXOAT "Reset DEXOAT\n"
#define L_CONFIG_MG "Config backup/restore\n"
#define L_STOP_CACHE_DAEMON "Cache blocking (Daemon)\n"
#define L_TIME_DAEMON "Scheduled tasks (Daemon)\n"
...
// For SetInstall.c
#define L_SI_OPEN_FAILED_STORAGE " » Failed to block updates in internal storage: %s\n"
#define L_SI_OPEN_SUCCESSFUL_STORAGE " » Updates have been blocked in internal storage!\n"
#define L_SI_OFF_FAILED_STORAGE " » Failed to disable update blocking in internal storage: %s\n"
...
#define L_SS_OPEN_STOP_STORAGE_FAILED " » Failed to enable internal storage pinning: %s\n"
#define L_SS_OFF_STOP_STORAGE_SUCCESSFUL " » Internal storage pinning has been disabled!\n"
#define L_SS_OFF_STOP_STORAGE_FAILED " » Failed to disable internal storage pinning: %s\n"
