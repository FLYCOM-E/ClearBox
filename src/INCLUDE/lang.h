...
static const LangPack lang_packs[] =
{
    ...
    [LANG_ja_JP] =
    {
        ...
        .l_not_use_root = " » Root 権限を使用してください！#%u\n",
        .l_args_failed = " » 引数が不足しています！\n",
        .l_mode_err = " » 不明なモードです！[%s]\n",
        .l_noconfig = " » 設定が見つかりません！\n",
        .l_open_path_failed = " » %s ディレクトリを開けませんでした: %s\n",
        .l_open_file_failed = " » %s ファイルを開けませんでした: %s\n",
        .l_mkdir_error = " » %s ディレクトリを作成できませんでした: %s\n",
        .l_mount_error = " » %s を %s にマウントできませんでした: %s\n",
        .l_get_applist_error = " » アプリリストの取得に失敗しました！\n",
        .l_get_sys_version_err = " » システムバージョンの取得に失敗しました！\n",
        .l_w_setprop_err = " » 警告：PROP の設定に失敗しました！\n",
        .l_move_error = " » %s の移動に失敗しました: %s\n",
        ...
        .l_clear_sys_cache = "システムキャッシュをクリア\n",
        .l_cust_storage_clean = "カスタムルールストレージクリーン\n",
        .l_storage_clean = "ストレージディレクトリクリーン\n",
        .l_file_clean = "ファイルクリーン\n",
        .l_cust_app_clean = "カスタムアプルールクリーン\n",
        .l_app_clean = "アプルールクリーン\n",
        .l_file_all = "ファイル分類\n",
        .l_stop_install = "インストールをブロック\n",
        .l_lock_storage = "ストレージロック\n",
        .l_fast_disk_gc = "高速ディスク最適化\n",
        .l_disk_gc = "ディスク GC\n",
        .l_sys_dexoat = "システム DEXOAT\n",
        .l_cust_dexoat = "カスタム DEXOAT\n",
        .l_reset_dexoat = "DEXOAT リセット\n",
        .l_config_mg = "設定バックアップ/復元\n",
        .l_stop_cache_daemon = "キャッシュブロック (デーモン)\n",
        .l_time_daemon = "自動タスク (デーモン)\n",
        .l_path_bind = "ルールディレクトリバインド（リダイレクト）\n",
        .l_storage_scan = "ストレージ分析（NCDU）\n",
        
        .l_scd_start_success = " » キャッシュブロックが開始されました！#%u",
        .l_scd_getapp_err_exit = " » プロセスが終了しました。理由：GETTOPAPP ERROR\n",
        .l_td_config_error = " » %s 設定エラー、スキップします。\n",
        .l_td_line_err_value = " » %s 設定：%d 行 %s の値が正しくありません。この行は無視されました\n",
        .l_td_line_err_key = " » %s 設定：%d 行 %s 未定義エラー。この行は無視されました\n",
        .l_td_max_config = " » 設定読み込み数の上限 %d に達しました。追加の設定はスキップされました\n",
        .l_td_config_success = " » %s 設定の読み込みに成功しました\n",
        .l_td_start_success = " » サービスが正常に起動しました！合計 %d 個の設定が読み込まれました！#%u",
        .l_td_w_post_title_toolong = " » 警告：%s 設定の通知タイトルが長さ制限を超えています！切り詰められました\n",
        .l_td_w_post_message_toolong = " » 警告：%s 設定の通知内容が長さ制限を超えています！切り詰められました\n",
        .l_td_config_write_error = " » %s 設定の書き戻しに失敗しました。\n",
        .l_td_watch_config_dir_error = " » ホットアップデート設定の初期化に失敗しました: %s\n",
        .l_td_load_config_success = " » %s 設定が更新されました\n",
        .l_ac_clear = " » %s をクリーン中 &\n",
        .l_ac_config_app_notfound = " » %s 設定で指定されたアプリが見つかりません！\n",
        .l_ac_config_package_err = " » %s 設定の宣言エラー：パッケージ名が正しく入力されていません！\n",
        .l_ac_config_appname_err = " » %s 設定の宣言エラー：アプリ名が正しく入力されていません！\n",
        .l_ac_config_err = " » %s 設定エラー！最初の行に正しく宣言を記入してください\n",
        .l_ac_config_err_1 = " » %s 設定の %d 行目に危険なエラーがあります：「/」で始まっています！\n",
        .l_ac_config_err_2 = " » %s 設定の %d 行目にエラーがあります：パスのエスケープ！\n",
        .l_ac_clear_path_err = " » %s のクリーンに失敗しました！\n",
        .l_ac_clear_path_success = " » %s の処理に成功しました！%.2f %c\n",
        .l_ac_clean_successful = " » アプリルールの処理に成功しました！合計クリーン量：%.2f %c\n",
        .l_ac_clean_failed = " » 指定されたアプリの設定が見つからないか、エラーが発生しました！#%d\n",
        .l_cc_clear_failed = " » 内部ストレージのアプリキャッシュクリーンに失敗しました\n",
        .l_cc_clear_successful = " » 内部ストレージのアプリキャッシュクリーンが完了しました\n » 合計クリーン量：%.2f %c\n",
        .l_cc_clear_failed_sd = " » 外部ストレージのアプリキャッシュクリーンに失敗しました\n",
        .l_cc_clear_successful_sd = " » 外部ストレージのアプリキャッシュクリーンが完了しました\n » 合計クリーン量：%.2f %c\n",
        .l_cc_clear = " » %s のキャッシュが削除されました\n",
        .l_cc_clear_skip = " » %s をスキップしました\n",
        .l_cc_clear_appcache_done = " » 合計 %d 個のアプリをクリーンし、%d 個のアプリはクリーンの必要がありませんでした\n",
        .l_cc_clear_systemcache = " » システムキャッシュが空になりました！システムの再起動を推奨します！\n",
        .l_do_run_system = " » システムデフォルトの Dexoat を実行中...\n",
        .l_do_run_cust = " » モード %s でコンパイルを実行中...\n",
        .l_fg_err_nof2fs = " » お使いのデバイスは F2FS ファイルシステムではありません\n » メンテナンスは F2FS 環境のみ対応しています！\n",
        .l_fg_err_check = " » お使いのデバイスは現在の GC 機能をサポートしていません\n",
        .l_fg_dirty = " » 現在のダーティセグメント：%ld\n",
        .l_fg_free = " » 現在の空きセグメント：%ld\n\n",
        .l_fg_start = " » バックグラウンド GC が開始されました。しばらくお待ちください\n",
        .l_fg_err_writesysfs = " » GC の起動に失敗しました！ノードへの書き込みに失敗しました！\n",
        .l_fg_err_timeout = " » GC の待機がタイムアウトしました。待機を終了しました！\n",
        .l_fg_end = " » GC の実行が完了し、終了しました！\n",
        .l_fg_run_ms = " » %d 分 %d 秒実行されました...\n",
        .l_fg_run_s = " » %d 秒実行されました...\n",
        .l_fg_end_dirty = " » ディスクのダーティブロックが %ld 減少しました。合計 %.2f %c\n",
        .l_fg_end_dirty_2 = " » ディスクのダーティブロックが %ld 増加しました\n » GC はまだ最適化中であるか、お使いのデバイスには適していない可能性があります！\n",
        .l_fg_fast_gc_done = " » 高速ディスク最適化が完了しました。よりアグレッシブな GC 最適化も試せますよ (・∀・)\n",
        .l_fg_dirty_low = " » ディスクの状態は非常に良好です。最適化は不要です (・∀・)\n",
        .l_fm_all_failed_storage = " » 内部ストレージのファイル分類に失敗しました！\n",
        .l_fm_all_successful_storage = " » 内部ストレージのファイル分類に成功しました！\n",
        .l_fm_all_failed_sd = " » 外部ストレージのファイル分類に失敗しました！\n",
        .l_fm_all_successful_sd = " » 外部ストレージのファイル分類に成功しました！\n",
        .l_fm_cr_failed_storage = " » 内部ストレージのファイルクリーンに失敗しました！\n",
        .l_fm_cr_successful_storage = " » 内部ストレージのファイルクリーンに成功しました！\n",
        .l_fm_cr_failed_sd = " » 外部ストレージのファイルクリーンに失敗しました！\n",
        .l_fm_cr_successful_sd = " » 外部ストレージのファイルクリーンに成功しました！\n",
        .l_fm_all_start = " » %s を分類中 ...\n",
        .l_fm_all_end = " » %d 個の %s を分類しました\n",
        .l_fm_cr_start = " » %s をクリーン中 ...\n",
        .l_fm_cr_end = " » %d 個の %s をクリーンしました\n",
        .l_fm_min_size_error = " » 警告：%s 設定の MIN サイズが MAX より大きいため、MIN は無視されました！\n",
        .l_fm_size_max_error = " » 警告：%s 設定の MAX 宣言が正しくありません！無視されました\n",
        .l_fm_size_min_error = " » 警告：%s 設定の MIN 宣言が正しくありません！無視されました\n",
        .l_fm_size_error = " » 警告：%s 設定のサイズ範囲単位が正しくありません！対応する値は無視されました\n",
        .l_open_freezer_successful = " » Android ネイティブフリーザーが有効になりました (^^)\n",
        .l_si_open_failed_storage = " » 内部ストレージの更新ブロックに失敗しました: %s\n",
        .l_si_open_successful_storage = " » 内部ストレージの更新がブロックされました！\n",
        .l_si_off_failed_storage = " » 内部ストレージの更新ブロック解除に失敗しました: %s\n",
        .l_si_off_successful_storage = " » 内部ストレージの更新ブロックが解除されました！\n",
        .l_ss_open_stop_storage_successful = " » 内部ストレージの固定が有効になりました！\n",
        .l_ss_open_stop_storage_failed = " » 内部ストレージの固定を有効にできませんでした: %s\n",
        .l_ss_off_stop_storage_successful = " » 内部ストレージの固定が無効になりました！\n",
        .l_ss_off_stop_storage_failed = " » 内部ストレージの固定を無効にできませんでした: %s\n",
        .l_sc_successful_storage = " » 内部ストレージのゴミクリーンが完了しました！\n » 合計 %d 個の空ファイル/フォルダおよびログファイルをクリーンしました\n",
        .l_sc_successful_sd = " » 外部ストレージ %s のゴミクリーンが完了しました！\n » 合計 %d 個の空ファイル/フォルダおよびログファイルをクリーンしました\n",
        .l_sc_clear = " » %s のストレージキャッシュをクリーン中\n",
        .l_sc_clear_err = " » %s のストレージキャッシュクリーンに失敗しました！\n",
        .l_sc_clear_cache_done = " » 合計 %d 個のアプリキャッシュをクリーンしました！\n",
        .l_sc_clear_dirty_err = " » 空ファイル/フォルダおよびログファイルのクリーンに失敗しました！\n",
        .l_sr_start = " » %s 設定を処理中📍\n",
        .l_sr_w_config_stattpath_err = " » 警告：%s 設定で指定された初期パスが存在しません！\n",
        .l_sr_clear_successful = " » %s のクリーンに成功しました！%.2f %c\n",
        .l_sr_clear_failed = " » %s のクリーンに失敗しました\n",
        .l_sr_line_failed_path_err = " » %d 行目のエラー：パスが間違っているかアクセスできません\n",
        .l_sr_end = " » カスタムディレクトリの処理が完了しました！\n",
        .l_bm_mount_success = " » ディレクトリ %s を %s にバインドすることに成功しました\n",
        .l_bm_error_is_sdcardfs = " » お使いのデバイスは sdcardfs を使用しているため、この機能は正常に動作しません！\n",
    },
};
